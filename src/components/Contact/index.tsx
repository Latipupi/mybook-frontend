                ...
                <div className="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div >
                    ...
                    <p className="text-base text-body-color dark:text-dark-6">
                      <strong>Apotek Sela Farma </strong>
                    Kp. Pugeran RT 003/001, Desa, Sukamaju, Kec. Bantarkalong, Kabupaten Tasikmalaya, Jawa Barat 46187
                    </p>
                    <br />
                    <hr />
                    <br />
                    <p className="text-base text-body-color dark:text-dark-6">
                      <strong>Apotek Grapi Farma </strong>
                      Jl. Raya Pamijahan, Pamijahan, Kec. Bantarkalong, Kabupaten Tasikmalaya, Jawa Barat 46187
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-[330px] max-w-full">
